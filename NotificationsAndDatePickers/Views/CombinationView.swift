    ...
    var body: some View {
        ScrollView {
            ...
            VStack(alignment: .leading) {
                ...
                Text("Here we allow the user to select some date and time in the future, and do some arithmetic to determine the number of seconds between the current date and time and what was selected. A notification is scheduled based upon that difference.")
